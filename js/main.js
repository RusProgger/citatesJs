...
function randomsButtonsClick() { 
    ...
    let citates = [
        ...
        ['Там, где кончается саморазвитие, начинается диван (писатель, консультант в вопросах управления временем и личной продуктивности'],
        ['Жизнь — это мысли, приходящие в течение дня (американский писатель и художник)']
    ];
